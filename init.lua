local formats = {
  standard = require("extra.prayertime.formats.standard"),
}
...
local function build_today_lines()
  ...
  if not current_index and next_index and entries[next_index] and entries[next_index].minutes and entries[next_index].minutes > now_minutes then
